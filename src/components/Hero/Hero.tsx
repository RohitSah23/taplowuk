...
export default function Hero() {
  return (
    <section className="font-[var(--font-nunito-sans)] relative bg-white min-h-screen flex items-center">
      ...
      <div className="absolute inset-0 bg-[url('https://images.pexels.com/photos/274422/pexels-photo-274422.jpeg')] opacity-5 bg-cover bg-center"></div>

      <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center md:items-stretch gap-8 md:gap-16 py-16">
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center text-black py-8 md:py-12">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6 sm:mb-8">
            <span className="block font-[var(--font-oswald)] text-red-600">
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 mb-10">
            <Link
              href="#membership"
              className="px-6 py-3 bg-red-600 hover:bg-red-700 text-white font-semibold rounded-full transition-all duration-300 text-center"
            >
              Membership Info
            </Link>
            <Link
              href="#contact"
              className="px-6 py-3 border-2 border-red-600 text-red-600 hover:bg-red-600 hover:text-white font-semibold rounded-full transition-all duration-300 text-center"
            >
              Contact Us
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-10 max-w-lg">
            <div className="bg-red-50 rounded-lg py-6 px-4">
              <div className="text-2xl sm:text-3xl font-bold mb-2 text-red-600">100+</div>
              <div className="text-sm sm:text-base text-gray-700">Players Registered</div>
            </div>
            <div className="bg-red-50 rounded-lg py-6 px-4">
              <div className="text-2xl sm:text-3xl font-bold mb-2 text-red-600">25+</div>
              <div className="text-sm sm:text-base text-gray-700">Years Experience</div>
            </div>
            <div className="bg-red-50 rounded-lg py-6 px-4">
              <div className="text-2xl sm:text-3xl font-bold mb-2 text-red-600">Taplow</div>
